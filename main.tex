...
\usepackage{cslav,pscyr,geometry,psfrag,graphicx,epigraph,ifthen} 
...
\end{titlepage}
\begin{figure}[h]
\center{\includegraphics[width=1\linewidth]{a.eps}}
\end{figure}
\pagecolor{SeaGreen}
...
\begin{figure}[h]
\center{\includegraphics[width=1\linewidth]{yo.eps}}
\end{figure}
\midcam{Од}{Ё}{жа}
\epigraph{Я еле-еле поднимаюсь, в темноте ищу штаны \\ Отбросив кресло, понимаю, что штаны не так важны}{Сергей Калугин}
 ...
 \begin{figure}[h]
\center{\includegraphics[width=1\linewidth]{p.eps}}
\end{figure}
